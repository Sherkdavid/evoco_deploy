<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RawData1.aspx.vb" Inherits="Evoco.RawData1" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PwrMeter" HeaderText="PwrMeter" 
                            SortExpression="PwrMeter" />
                        <asp:BoundField DataField="AvgWindSpeed" HeaderText="AvgWindSpeed" 
                            SortExpression="AvgWindSpeed" />
                        <asp:BoundField DataField="RPMAvg" HeaderText="RPMAvg" 
                            SortExpression="RPMAvg" />
                        ...
                        <asp:BoundField DataField="ACDumpLoad" HeaderText="ACDumpLoad" 
                            SortExpression="ACDumpLoad" />
                        <asp:BoundField DataField="DCDumpLoad" HeaderText="DCDumpLoad" 
                            SortExpression="DCDumpLoad" />
                        ...
                        <asp:BoundField DataField="BattCurrent" HeaderText="BattCurrent" 
                            SortExpression="BattCurrent" />
                        ...
                        <asp:BoundField DataField="RPMPeak" HeaderText="RPMPeak" 
                            SortExpression="RPMPeak" />
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:evocodbConnectionString %>"
                    ...
                    SelectCommand="SELECT TOP (1000) LoggedTime, Time, PwrGen, PwrMeter, AvgWindSpeed, RPMAvg, BattVolt, TurbDC, ACDumpLoad, DCDumpLoad, Temp, InvAdd, InvState, PCB, InvDCI, InvACV, InvACI, InvACF, Power, PowerMonth, PeakWind, IGBT, AC1, AC2, AC3, BattCurrent, StatTXT, Status1, Status2, Status3, Ram, RPMPeak FROM [819215-1] ORDER BY LoggedTime DESC">
                </asp:SqlDataSource>
            </ContentTemplate>
        </asp:UpdatePanel>
        <table>
