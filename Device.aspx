<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Evoco.Master"
    CodeBehind="Device.aspx.vb" Inherits="Evoco.Device" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="tabs">
        ...
        <div id="tabs-1" style="min-height: 200px;">
            ...
            <strong>Turbine Status:</strong>
            <asp:Label ID="lblTurbineStatus" runat="server" Text="Running" BackColor="Lime"></asp:Label><br />
    ...
    <br />
    <div id="placeholder1" style="width: 900px; height: 300px; display: table-cell; margin: 10px">
    </div>
    <div style="clear: both;">
    </div>
    <br />
    <div id="placeholder2" style="width: 900px; height: 300px; display: table-cell; margin: 10px">
    </div>
    <div style="clear: both;">
    </div>
    <br />
